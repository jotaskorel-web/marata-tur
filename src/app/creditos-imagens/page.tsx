...
export const metadata: Metadata = {
  ...
  description: 'Créditos e licenças das fotografias de destinos usadas no site da Luzy Tour.',
}
        ...
        <Container className="pb-20">
          ...
          <div className="mx-auto max-w-3xl rounded-2xl bg-white p-8 shadow-sm md:p-12">
            ...
            <p className="mb-8 text-gray-600">
              Fotografias reais dos destinos da Luzy Tour, utilizadas sob licenças livres. As imagens
              foram redimensionadas e recortadas automaticamente conforme o espaço disponível no site.
            </p>
